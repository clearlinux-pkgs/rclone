...
Source0  : https://github.com/rclone/rclone/releases/download/v1.65.1/rclone-v1.65.1.tar.gz
Source1  : http://localhost/cgit/projects/rclone-vendor/snapshot/rclone-vendor-1.65.1.tar.xz
...
%prep
%setup -q -n rclone-v1.65.1
cd %{_builddir}
tar xf %{_sourcedir}/rclone-vendor-1.65.1.tar.xz
cd %{_builddir}/rclone-v1.65.1
mkdir -p ./
cp -r %{_builddir}/rclone-vendor-1.65.1/* %{_builddir}/rclone-v1.65.1/./
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705935132
...
cp %{_builddir}/rclone-vendor-%{version}/vendor/github.com/Mikubill/gofakes3/LICENSE %{buildroot}/usr/share/package-licenses/rclone/28e4e3e37177204e0349e5d3a17e8558011e49e4 || :
...
cp %{_builddir}/rclone-vendor-%{version}/vendor/github.com/jtolio/eventkit/LICENSE %{buildroot}/usr/share/package-licenses/rclone/2f93c6a8ed03b9cf20bcae41907516d96dd7fcd1 || :
...
cp %{_builddir}/rclone-vendor-%{version}/vendor/github.com/matttproud/golang_protobuf_extensions/v2/LICENSE %{buildroot}/usr/share/package-licenses/rclone/92170cdc034b2ff819323ff670d3b7266c8bffcd || :
