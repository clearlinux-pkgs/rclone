...
Source1  : http://localhost/cgit/projects/rclone-vendor/snapshot/rclone-vendor-1.63.1.tar.xz
...
cd %{_builddir}
tar xf %{_sourcedir}/rclone-vendor-1.63.1.tar.xz
cd %{_builddir}/rclone-v1.63.1
mkdir -p ./
cp -r %{_builddir}/rclone-vendor-1.63.1/* %{_builddir}/rclone-v1.63.1/./
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1691797441
